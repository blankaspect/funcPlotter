    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private CPMaxEditListLength( )
        {
            super( concatenateKeys( Key.GENERAL, Key.MAX_EDIT_LIST_LENGTH ),
                   FunctionDocument.MIN_MAX_EDIT_LIST_LENGTH, FunctionDocument.MAX_MAX_EDIT_LIST_LENGTH );
...
//--////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        {
            super( concatenateKeys( Key.APPEARANCE, Key.BACKGROUND_COLOUR ) );
        }
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        public String toString( )
        {
            return ( (value == null) ? null : ColourUtilities.colourToRgbString( value ) );
        }
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private Color getColour( )
        {
            ...
            if ( colour == null )
            {
                colour = UIManager.getColor( PANEL_BACKGROUND_COLOUR_KEY );
                if ( colour == null )
...
//--////////////////////////////////////////////////////////////////////
    ...
    {
        return ( cpBackgroundColour.getValue( ) != null );
    }
    ...
    {
        return cpBackgroundColour.getColour( );
    }
    ...
    {
        cpBackgroundColour.setValue( value );
    }
...
//--////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        {
            super( concatenateKeys( Key.PLOT, Key.NUM_FRACTION_DIGITS ),
                   MIN_NUM_FRACTION_DIGITS, MAX_NUM_FRACTION_DIGITS );
            value = 5;
        }
...
//--////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        {
            super( concatenateKeys( Key.PLOT, Key.NUM_Y_SCALE_DIGITS ),
                   PlotPanel.MIN_NUM_Y_SCALE_DIGITS, PlotPanel.MAX_NUM_Y_SCALE_DIGITS );
            value = 8;
        }
...
//--////////////////////////////////////////////////////////////////////
    ...
    private CPNormaliseScientificNotation   cpNormaliseScientificNotation =
                                                                    new CPNormaliseScientificNotation( );
...
//--////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
                              ...
                              int   index )
        {
            try
            {
                values.set( index, input.parseColour( ) );
            }
            catch ( AppException e )
            {
...
////////////////////////////////////////////////////////////////////////
    ...
    private static URL getURL( JApplet applet )
        throws AppException
    {
        URL url = null;
        String pathname = applet.getParameter( CONFIG_DIR_KEY );
        if ( pathname != null )
        {
            int length = pathname.length( );
            if ( (length > 0) && (pathname.charAt( length - 1 ) != '/') )
                pathname += '/';

            try
            {
                url = new URL( applet.getCodeBase( ), pathname + CONFIG_FILENAME );
                if ( url.getProtocol( ).equals( "file" ) )
                {
                    String urlPath = url.getPath( );
                    if ( urlPath.equals( "/" + PropertyString.USER_HOME_PREFIX ) ||
                         urlPath.startsWith( "/" + PropertyString.USER_HOME_PREFIX + "/" ) )
                        urlPath = urlPath.substring( 1 );
                    url = new URL( url.getProtocol( ), url.getHost( ),
                                   PropertyString.parsePathname( urlPath ) );
                }
            }
...
////////////////////////////////////////////////////////////////////////
    ...
    public void read( FuncPlotter applet )
    {
        ...
        // Get properties
        Property.Source propertySource = (applet == null) ? Property.getSystemSource( )
                                                          : applet;
        if ( fileRead )
