...
////////////////////////////////////////////////////////////////////////
	...
	public static final		FuncPlotterApp	INSTANCE	= new FuncPlotterApp();
...
////////////////////////////////////////////////////////////////////////
	...
	private File chooseExport()
	{
		...
		{
			exportFile = Utils.appendSuffix(exportFileChooser.getSelectedFile(), AppConstants.PNG_FILENAME_EXTENSION);
			return exportFile;
		}
		return null;
	}
												 ...
												 String           title)
	{
		...
		switch (AppConfig.INSTANCE.getSaveFunctionColours())
		{
			...
			case ASK:
				switch (JOptionPane.showConfirmDialog(mainWindow, SAVE_COLOURS_STR, title,
