...
class FunctionView
    ...
    implements ActionListener, ChangeListener, ListSelectionListener, MouseListener, MouseMotionListener,
               MouseWheelListener, SingleSelectionList.ModelListener
{
...
////////////////////////////////////////////////////////////////////////
    ...
    // Key actions
    private static final    KeyAction.KeyActionPair[]   APPLET_VIEW_KEY_ACTIONS =
    {
        new KeyAction.KeyActionPair( KeyStroke.getKeyStroke( KeyEvent.VK_G, KeyEvent.CTRL_DOWN_MASK ),
                                     FunctionDocument.Command.TOGGLE_SHOW_GRID ),
        new KeyAction.KeyActionPair( KeyStroke.getKeyStroke( KeyEvent.VK_Z, KeyEvent.CTRL_DOWN_MASK ),
                                     FunctionDocument.Command.UNDO ),
        new KeyAction.KeyActionPair( KeyStroke.getKeyStroke( KeyEvent.VK_Y, KeyEvent.CTRL_DOWN_MASK ),
                                     FunctionDocument.Command.REDO ),
    };
...
////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        private CoordinatesField( )
        {
            ...
            charWidth = Math.max( GuiUtilities.getCharWidth( 'x', fontMetrics ),
                                  GuiUtilities.getCharWidth( 'y', fontMetrics ) );
            char[] zeros = StringUtilities.createCharArray( '0', PlotInterval.MAX_NUM_SIGNIFICANT_DIGITS );
...
////////////////////////////////////////////////////////////////////////
    ...
    public FunctionView( FunctionDocument document )
    {
        ...
        Color backgroundColour = config.getBackgroundColour( );


        //----  Plot panel

        plotPanel = new PlotPanel( document, plotSize.width + 1, plotSize.height + 1,
                                   config.isShowGrid( ) );
        plotPanel.setBackground( backgroundColour );
        ...
        functionButtonPanel.setBackground( backgroundColour );
        ...
        {
            JComponent filler = GuiUtilities.createFiller( 8, 1 );
            ...
            functionButtonPanel.add( filler );

            JButton undoButton = new FunctionButton( FunctionDocument.Command.UNDO );
            ...
            gbc.fill = GridBagConstraints.NONE;
            gbc.insets = AppConstants.COMPONENT_INSETS;
            gridBag.setConstraints( undoButton, gbc );
            functionButtonPanel.add( undoButton );
        }
        ...
        if ( App.getInstance( ).isApplet( ) )
        {
            ...
            JButton redoButton = new FunctionButton( FunctionDocument.Command.REDO );
            ...
            gbc.fill = GridBagConstraints.NONE;
            gbc.insets = AppConstants.COMPONENT_INSETS;
            gridBag.setConstraints( redoButton, gbc );
            functionButtonPanel.add( redoButton );
        }
        ...
        GuiUtilities.setPaddedLineBorder( functionPanel, 4 );
        functionPanel.setBackground( backgroundColour );
        ...
        GuiUtilities.setPaddedLineBorder( coordPanel );
        coordPanel.setBackground( backgroundColour );
        ...
        GuiUtilities.setPaddedLineBorder( intervalPanel );
        intervalPanel.setBackground( backgroundColour );
        ...
        GuiUtilities.setPaddedLineBorder( scrollPanel, 2 );
        Color scrollZoomBackgroundColour = ColourUtilities.scaleBrightness( backgroundColour, 0.95f );
        scrollPanel.setBackground( scrollZoomBackgroundColour );

        scrollPanel.add( GuiUtilities.createFiller( ) );
        ...
        xZoomPanel.setBackground( backgroundColour );
        ...
        GuiUtilities.setPaddedLineBorder( xZoomButtonPanel, 2 );
        ...
        yZoomPanel.setBackground( backgroundColour );
        ...
        GuiUtilities.setPaddedLineBorder( yZoomButtonPanel, 2 );
        ...
        zoomPanel.setBackground( backgroundColour );
        ...
        GuiUtilities.setPaddedLineBorder( scrollZoomPanel, 4, 6 );
        scrollZoomPanel.setBackground( backgroundColour );
...
////////////////////////////////////////////////////////////////////////
//  Instance methods : SingleSelectionList.ModelListener interface
////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////
    ...
    private void showContextMenu( MouseEvent event )
    {
        if ( (event == null) || event.isPopupTrigger( ) )
        {
            ...
            if ( contextMenu == null )
            {
                ...
                {
                    contextMenu.addSeparator( );
                    contextMenu.add( new FMenuItem( FunctionDocument.Command.UNDO ) );
                    contextMenu.add( new FMenuItem( FunctionDocument.Command.REDO ) );
                }
            }
        ...
        throws AppException
    {
        ...
        {
            GuiUtilities.setFocus( xLowerEndpointField );
            throw e;
        }
        ...
        {
            GuiUtilities.setFocus( xUpperEndpointField );
            throw e;
        }
        ...
        throws AppException
    {
        ...
        {
            GuiUtilities.setFocus( yLowerEndpointField );
            throw e;
        }
        ...
        {
            GuiUtilities.setFocus( yUpperEndpointField );
            throw e;
        }
