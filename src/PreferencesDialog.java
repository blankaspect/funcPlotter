...
import uk.org.blankaspect.util.NoYesAsk;
...
////////////////////////////////////////////////////////////////////////
    ...
    {
        String  TOGGLE_BACKGROUND_COLOUR            = "toggleBackgroundColour";
...
////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        FIXED_POINT_LIMITS_OUT_OF_ORDER
        ( "The upper limit of the fixed-point exponent range is less than the lower limit." );
...
////////////////////////////////////////////////////////////////////////
    ...
    public void actionPerformed( ActionEvent event )
    {
        ...
        if ( command.equals( Command.TOGGLE_BACKGROUND_COLOUR ) )
            onToggleBackgroundColour( );

        else if ( command.equals( Command.CHOOSE_BACKGROUND_COLOUR ) )
            onChooseBackgroundColour( );

        else if ( command.equals( Command.CHOOSE_PLOT_COLOUR_FOCUSED_BORDER ) )
            ...
            onChooseFunctionColour( StringUtilities.removePrefix( command,
...
////////////////////////////////////////////////////////////////////////
    ...
    private void onToggleBackgroundColour( )
    {
        backgroundColourButton.setEnabled( backgroundColourCheckBox.isSelected( ) );
    }
    ...
    private JPanel createPanelAppearance( )
    {
        ...
        // Check box: background colour
        backgroundColourCheckBox = new FCheckBox( BACKGROUND_COLOUR_STR );
        backgroundColourCheckBox.setSelected( config.isBackgroundColour( ) );
        backgroundColourCheckBox.setActionCommand( Command.TOGGLE_BACKGROUND_COLOUR );
        backgroundColourCheckBox.addActionListener( this );
        ...
        gbc.fill = GridBagConstraints.NONE;
        gbc.insets = AppConstants.COMPONENT_INSETS;
        gridBag.setConstraints( backgroundColourCheckBox, gbc );
        controlPanel.add( backgroundColourCheckBox );

        // Button: background colour
        backgroundColourButton = new ColourButton( config.getBackgroundColour( ) );
        backgroundColourButton.setEnabled( backgroundColourCheckBox.isSelected( ) );
        ...
        controlPanel.add( backgroundColourButton );
    ...
    private JPanel createPanelPlot( )
    {
        ...
        // Spinner: fixed-point exponent lower limit
        fixedPointLowerLimitSpinner = new FIntegerSpinner( config.getFixedPointExponentRange( ).lowerLimit,
                                                           AppConfig.MIN_FIXED_POINT_EXPONENT_LIMIT,
                                                           AppConfig.MAX_FIXED_POINT_EXPONENT_LIMIT,
        ...
        gbc.fill = GridBagConstraints.NONE;
        gbc.insets = new Insets( 0, 0, 0, 0 );
        gridBag.setConstraints( fixedPointLowerLimitSpinner, gbc );
        fixedPointRangePanel.add( fixedPointLowerLimitSpinner );
        ...
        // Spinner: fixed-point exponent upper limit
        fixedPointUpperLimitSpinner = new FIntegerSpinner( config.getFixedPointExponentRange( ).upperLimit,
                                                           AppConfig.MIN_FIXED_POINT_EXPONENT_LIMIT,
                                                           AppConfig.MAX_FIXED_POINT_EXPONENT_LIMIT,
                                                           FIXED_POINT_RANGE_FIELD_LENGTH, true );
        ...
        gbc.fill = GridBagConstraints.NONE;
        gbc.insets = new Insets( 0, 4, 0, 0 );
        gridBag.setConstraints( fixedPointUpperLimitSpinner, gbc );
        fixedPointRangePanel.add( fixedPointUpperLimitSpinner );
    ...
    private JPanel createPanelFunction( )
    {
        ...
        GuiUtilities.setPaddedLineBorder( topPanel );
        ...
        throws AppException
    {
        ...
        try
        {
            if ( fixedPointLowerLimitSpinner.getIntValue( ) > fixedPointUpperLimitSpinner.getIntValue( ) )
                throw new AppException( ErrorId.FIXED_POINT_LIMITS_OUT_OF_ORDER );
        }
        catch ( AppException e )
        {
            setFocus( Tab.PLOT, fixedPointUpperLimitSpinner );
            throw e;
        }
    }
    ...
    private void setPreferencesAppearance( )
    {
        ...
        config.setBackgroundColour( backgroundColourCheckBox.isSelected( )
                                                                ? backgroundColourButton.getForeground( )
                                                                : null );
    }
    ...
    private void setPreferencesPlot( )
    {
        ...
        config.setFixedPointExponentRange( new IntegerRange( fixedPointLowerLimitSpinner.getIntValue( ),
                                                             fixedPointUpperLimitSpinner.getIntValue( ) ) );
