...
////////////////////////////////////////////////////////////////////////
    ...
    public static FunctionDialog showDialog( Component parent,
                                             ...
                                             String    expression )
    {
        return new FunctionDialog( GuiUtilities.getWindow( parent ), titleStr, colour, expression );
    }
...
////////////////////////////////////////////////////////////////////////
    ...
    public void actionPerformed( ActionEvent event )
    {
        ...
        if ( command.equals( Command.CHOOSE_COLOUR ) )
            ...
            onSetToFunctionColour( StringUtilities.removePrefix( command,
...
////////////////////////////////////////////////////////////////////////
    ...
    private void onCopy( )
    {
        try
        {
            Util.putClipboardText( expressionField.getText( ) );
        }
    ...
    private void onPaste( )
    {
        try
        {
            expressionField.setText( Util.getClipboardText( ) );
        }
        catch ( AppException e )
        {
            JOptionPane.showMessageDialog( this, e, App.SHORT_NAME, JOptionPane.ERROR_MESSAGE );
