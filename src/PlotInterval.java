...
////////////////////////////////////////////////////////////////////////
                                         ...
                                         int          fixedExponent )
    {
        ...
        if ( pointIndex < 0 )
        {
            buffer.append( StringUtilities.createCharArray( '0', -pointIndex ) );
            pointIndex = 0;
        }
        buffer.append( sigStr );
        int maxLength = Math.min( pointIndex + numFractionDigits, buffer.length( ) - 2 );
        if ( pointIndex > buffer.length( ) )
            buffer.append( StringUtilities.createCharArray( '0', pointIndex - buffer.length( ) ) );
        ...
        if ( pointIndex < 0 )
        {
            buffer.insert( 0, StringUtilities.createCharArray( '0', -pointIndex ) );
            pointIndex = 0;
        }
        if ( pointIndex > buffer.length( ) )
            buffer.append( StringUtilities.createCharArray( '0', pointIndex - buffer.length( ) ) );
