### blankaspect/funcPlotter

This repository contains the source code and resources of the FuncPlotter application.  The repo conforms to the Maven
...
* You may use the contents of the `uk.blankaspect.funcplotter` package \(including resources\) under the terms of the
